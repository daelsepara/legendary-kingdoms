...
namespace Spells
{
    ...
    auto POISON_STREAM = Spells::Base("Poison Stream", "A sickly green poison jets from your hands. Make two immediate attacks with a Fighting score of 5, against two different opponents.", Spells::Scope::COMBAT, Spells::Type::POISON_STREAM, 50);
    ...
    auto DAZING_LIGHTS = Spells::Base("Dazing Lights", "Swirling lights dazzle your foes' eyes. When your opponent's attack this round, they must reduce the score of each of their attack rolls by 1 point.", Spells::Scope::COMBAT, Spells::Type::DAZING_LIGHTS, 50);
