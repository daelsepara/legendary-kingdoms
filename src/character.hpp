...
namespace Character
{
    ...
    public:
        ...
        Base(const char *name, const char *image, const char *background, std::vector<Attribute::Base> attributes, int health, bool spellCaster)
        {
            Name = name;
        ...
        Base(const char *name, const char *image, const char *background, std::vector<Attribute::Base> attributes, std::vector<Equipment::Base> equipment, int health, bool spellCaster)
        {
            Name = name;
