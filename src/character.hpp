...
namespace Character
{
    ...
    auto SAR_JESSICA_DAYNE = Character::Base("Sar Jessica Dayne", Character::Type::SAR_JESSICA_DAYNE, "images/characters/sar-jessica-dayne.png", "Sar Jessica Dayne is a first-born knight of Royce. Her father, Baron Baldwin Dayne, is an ambitious contender for the rulership of Longport Bay, an important county. She is a powerful warrior, of impeccable noble blood, but she has received little love or affection since the death of her mother when Jessica was a girl. She is due to inherit the barony in preference to her younger brother, Ridley, but has clashed with her father in recent years, putting her inheritance in doubt. Sar Jessica hopes to become a rich and important woman in her own right before confronting her father at Fosterly Castle.", {Attribute::Base(Attribute::Type::FIGHTING, 5), Attribute::Base(Attribute::Type::STEALTH, 1), Attribute::Base(Attribute::Type::LORE, 3), Attribute::Base(Attribute::Type::SURVIVAL, 2), Attribute::Base(Attribute::Type::CHARISMA, 3)}, {Equipment::LEATHER_ARMOUR1, Equipment::SHIELD2}, 8, false);
